...
**Answer** Wrong data type in voters and turnout column (they should be numeric). Empty rows in Jurisdiction wide and BEND. The precincts don't have a column header name.
...
**Answer** "Jurisdiction Wide" and "BEND" remain. "ABSENTEE" isn't a physical location, but shows up as one.
...
**Answer** 21 instead of 23 rows. We got rid of Jurisdiction and BEND and kept ABSENTEE.
