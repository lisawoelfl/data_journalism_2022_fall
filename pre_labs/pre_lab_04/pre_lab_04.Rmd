...
**Answer** There are now 24 rows, there should be 25, but "total" is excluded.
...
**Answer** I don't get an error message - I believe the code creates a new dataframe, joining our pop data and demographocs.
...
**Answer** Prince George's County has the highest percentage of Black population 18+, which is 60.9% - the percentage of Democrats is 78.3%
...
**Answer** Howard County has the largest percentage, 19.4%, democrats: 53.4%. Way less Asian population and also way less democrats in the county
...
**Answer** Data type is character now
