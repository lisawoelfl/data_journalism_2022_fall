...
**Answer** The dataframe has columns for the URL, date, title and the full text of the press releases. We have 999 rows.
...
**Answer** Shows me each value in the list, but no doubles. The code is case sensitive.
...
**Answer** It's giving me a list of almost 600k unique words from the press release.
...
**Answer** Shows me the most often used words. It's not interesting YET, as the top spots are words like the, and, to, of,...
...
**Answer** Yes! Now my top words art health, support, act, funding,... We can gather some information about issues that are often mentioned in press releases.
...
**Answer** A table for each year - we can see that health was used often in both years. Covid was in the top 10 in 2021, but not in 2022. In 2022, Baltimore appeared on the top list, could be interesting?
...
**Task** Run the following code and describe the results.
**Answer** The new dataframe contains two word phrases and catapults covid 19 to the number 1 spot. Health is a prominent issue still.
...
**Task** Run the following code and describe the results.
**Answer** Covid is now #2, Baltimore City is new, as is Mental Health.
...
**Answer** Right in the beginning: "work" as positive, could go either way. Also "critical" as negative and "trump" as positive - we know that Cardin probably wouldn't refer to Trump in a positive context.
