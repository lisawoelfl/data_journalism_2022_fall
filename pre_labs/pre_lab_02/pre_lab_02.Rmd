...
**Answer** The code is calculating new values for a new column. Specifically, the code calculates the percentage of election day voting of all votes. The data shows up in decimal numbers.
...
**Answer**
The new tibble is sorted by percentages. On top we have the one man that got all of his votes on election day.
...
**Answer**
Probably yes - because voting on election day is standard. Data that shows where not even every second vote came in on election day, could be more interesting. For politicians they want to know WHEN people are voting to reach them in time.
...
**Answer**
str_to_lower - will make my data lower case
str_to_title - makes the first letter upper case in every word, rest lower case
...
**Answer** 
We want a new column that groups the contributions in categories. We give the code conditions on how to know which amount belongs in which category. If the amount is less than 100 we want the category to say "Less than $100" and so on.
...
**Answer** 
"Less than $100" is the largest category in terms of money.
...
**Answer:**
The dates look different now, also the row under "expenditure_date" now says "date" instead of "chr".
...
**Answer**
Its year-month-date - they dates describe the whole month.
