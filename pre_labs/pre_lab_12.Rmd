...
**Answer** The code extracts the tables and turns them into a "list"
...
**Answer** We can make the list a dataframe using "as_tibble". The code below cleans up the dataframe so we can actually use it, renaming columns etc.
...
**Task** Run the following code and describe the result.
**Answer** Did the same thing but with another table from our original list regarding the removals.
...
**Answer** Unaffiliated voters are less likely to register by mail but are overrepresented when registering at the DMV.
...
**Task** Run the following code and describe what you think are the most interesting percentages in the dataframe.
**Answer** Republicans and unaffiliated voters are overrepresented when removed because they moved out of state, while Republicans are underrepresented in the category moving out of the county.
...
**Answer** The new dataframe is called "new_registrations_2022_06"
...
**Answer** October and June have 17 rows, but the new dataframe only has 16.
...
**Answer** New registrations went up for dems and unaffiliated voters, but down for reps. 7% increase in online registrations for unaf, while number went down for dems and reps. Same for absentee ballots.
...
**Answer** The graph shows that registrations by eric report, absentee ballots and volunteering are overwhelmingly democrat.
...
**Answer** Registrations by eric report were much more important for dems in October, while provisional ballots were more important in June. The order of types of new registrations is very different.
