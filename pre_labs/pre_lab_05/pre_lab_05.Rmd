...
**Answer** Our names aren't cleaned, W. MILLAR & CO vs W. MILLAR & CO.
...
**Answer** Now JOE'S SEAFOOD has a column. Also: LE DIPLOMATE, LE DIPLOMATE is now LE DIPLOMATE.
...
**Answer** W. MILLAR & CO. now has a period every time. HILTON WASHINGTON is now WASHINGTON PIZZA. PIZZA, WE THE is now WE THE PIZZA.
...
```{r}
# Load data
clean_dc_food <- read_csv("data/clean_dc_food.csv")
