...
**Answer** We are creating a new dataframe, arranging the counties according to the values in the TOTAL_DIFF column, select two colums we want to see and specify that we want to see the first 10 rows.
...
**Answer** The code is creating an empty container.
...
**Task** Run the following code. Explain what you see after running the code in the space below.
**Answer** I see a bar chart (it's not pretty) that shows the TOTAL_DIFF values. The counties are arranged alphabetically.
...
**Answer** The bars are now sorted, going from small to big.
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer** The bars are now horizontal, which means I can see the county names in full.
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer** The background is now white instead of grey.
...
**Answer** Background colors and lines have changed, the vertical description is very close to our county names now, which isn't ideal.
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer** We renamed the x and y titles - but they're wrong. It should be the other way around. I made another chart with the correct names, see below. We also have a source caption now.
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** I see a table with dates and the numbers of total contributions.
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** I see a line chart, the date is on the x axis and summarised so I can see the months, not every single date. I can see that the number of total contributions went up sharply at the end of June.
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** The x axis is much more detailed now, I can see ticks for weeks instead of months.
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** The date names are now flipped and easier to read.
```{r}
md_winred_by_date %>%
  ggplot() + 
  geom_line(aes(x=date, y=total_contributions)) + 
