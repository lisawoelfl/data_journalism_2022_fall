...
**Answer** The column names aren't great, our values are characters, but should be numbers. In the total row, we have total votes as well as percentages.
...
**Answer** The position of the columns in our dataframe
...
**Answer** It strips away the rest of the HTML and shows me the text inside the code.
...
**Answer** A table with a single column "value" with the text, 57 rows.
