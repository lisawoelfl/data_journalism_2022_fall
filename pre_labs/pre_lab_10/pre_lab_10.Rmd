...
https://datawrapper.dwcdn.net/qaLEL/1/
...
md_gov_county <- md_gov_county %>% 
  ...
  mutate(Percentage_Moore = Moore/total_votes*100)
...
Now only MD counties show up in the map.
...
**Answer** Describe the changes from the previous map
The tooltips are actually helpful now.
...
https://datawrapper.dwcdn.net/j8aPG/1/