...
**Answer** 10 columns, 356 rows. The columns include some we haven't seen before regarding shape. I suspect, those will help us make maps.
...
**Answer** Info on precincts and their shapes.
...
**Answer** I can see a map with Prince George's County's precincts drawn on it.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The library is now installed.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** I now have a huge dataset that has the shapefiles of all US counties.
```{r}
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** We filtered the dataset to only have the MD counties, which have the "FP" 24.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The new map has all the MD counties.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** We filtered the MD counties to only show PG county as our base map and layered the precinct data on top of that. The boundaries of the two layers are slightly different.
...
**Task** Run the following code. Describe the output in the space below.
**Answer** The dataset has precincts and votes for the 22 primary in PG County.
...
**Task** Run the following code. Describe the output in the space below.
**Answer** The datasets are now joined.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The map shows the numbers of total eligible voters in PG precincts. Some precincts have none.
...
**Answer** Libraries are now installed.
...
library(janitor)
library(tidycensus)
#census_api_key("832111ee36459ae04b4d63111802dc4c05994a34")
```
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Dataset shows population of MD counties + shapes.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Just showing us the dataframes.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The names are now clean.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** We joined the dataframes, but there are NA values.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** We changed the name of the counties to match.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** We have a new colum "voter_per_10k". The data is arranged from highest to lowest.
...
Okay, now let's visualize.  We're going to build a chloropleth map, with the color of each county -- the fill -- set according to the number of voters per 10K on a color gradient.  

### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The map shows voter per 10k population per MD county.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Colors are different now.
```{r}
ggplot() +
  geom_sf(data=md_voters_per_10k, aes(fill=voters_per_10k)) +
  theme_minimal() +
...
**Answer** The wealthier counties seem to have more voters per 10k.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Same thing now with voters per 10k unaffiliated.
...
**Answer** Map that shows the rate of unaffiliated voters per MD county.
