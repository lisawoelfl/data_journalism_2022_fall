...
A2. I'm lost on trying to figure out how to add the filter to the code, so my answer is precinct 5002 in Montgomery County for the most votes - BUT those include votes for all types, unfortunately. For the sake of the lab, I must continue with my faulty table.
