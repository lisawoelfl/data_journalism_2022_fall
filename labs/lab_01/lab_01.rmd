...
**A2** Martinsburg, 781 contributions
...
**A3** There are a lot of cities with only 1 contributions, for example: Auburn, Belle and Belmont.
...
**A4** 
Probably: population. Auburn has only a population of 96. Martinsburg has over 17.000 people.
...
**A5** 
"SAVE AMERICA JOINT FUNDRAISING COMMITTEE", total amount is 66,972.89 dollar, they got 2,448 contributions, the average donation was 27.36 dollars.
```{r}
wv_winred_contribs %>%
  group_by(memo_text) %>%
  summarise(
...
**A7**. 
Count: 13382, total amount: 356828.60, average: 26,66, median: 10, smallest: 0.01, largest: 5800
```{r}
